...
- Шрифт: **Lora**
- Иконки: `react-icons` + собственный SVG-спрайт (`IconSprite`)
...
выводится на `/privacy-policy`. Актуальность текста (соответствие реально
используемым сервисам — EmailJS, отсутствие аналитических cookie и т.д.) стоит
перепроверять при каждом изменении стека или добавлении новых сторонних сервисов
на сайт.
